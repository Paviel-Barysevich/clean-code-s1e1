...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("item__task-edition");
  //If class of the parent is .item__task-edition
  if(containsClass){

    //switch to .item__task-edition
  ...
  //toggle .item__task-edition on the parent.
  listItem.classList.toggle("item__task-edition");
};
